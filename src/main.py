...
def main():
    ...
    # ✅ Usamos la función importada pasándole únicamente tu CV y tus reglas
    ...
    evaluaciones = resultados_ia.get("vacantes_evaluadas", [])
    if evaluaciones:
        db.guardar_vacantes_evaluadas(vacantes_nuevas, evaluaciones)
